...
contract DegenToken is ERC20 {
    ...
    string public tokenName = "DEGEN VALORANT";
    string public tokenSymbol = "DGt-V";
    ...
    function shopItems() public pure returns(string memory) {
        return "1. Vandal_SKIN [800 DGN] 2. OPERATOR_SKIN [600 DGN] 3. PHANTOM_SKIN [250 DGN] 4. SHERIFF_SKIN [175 DGN]";
    }
